...
//Vibe coded by Rabelus Lab - Copyright 2025
...
Return ONLY RAW HTML. No markdown fences.
  ...
  return (
    <>
        <a href="https://x.com/rabelus" target="_blank" rel="noreferrer" className={`creator-credit ${hasStarted ? 'hide-on-mobile' : ''}`}>
            Rabelus Lab - Copyright 2025
        </a>
            ...
            <div className={`stage-container ${focusedArtifactIndex !== null ? 'mode-focus' : 'mode-split'}`}>
                 <div className={`empty-state ${hasStarted ? 'fade-out' : ''}`}>
                     <div className="empty-content">
                         <h1>Logus UI</h1>
                         <p>Geração criativa de interfaces em um instante</p>
                         <button className="surprise-button" onClick={handleSurpriseMe} disabled={isLoading}>
                             <SparklesIcon /> Me Surpreenda
                         </button>
                     </div>
                 </div>
